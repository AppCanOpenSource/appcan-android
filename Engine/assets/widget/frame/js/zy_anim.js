...
function zy_anim_slide(a, b, d) {
	if(curAnim) 
		return;
    if (!d) d = 1;
    curAnim = new zy_anim(document.getElementById(a), document.getElementById(b), d,0);
    curAnim.int=setInterval("zy_anim_slide_h()", 1);
}
function zy_anim_slide_ver(a, b, d) {
	if(curAnim) 
		return;
    if (!d) d = 1;
    curAnim = new zy_anim(document.getElementById(a), document.getElementById(b), d,1);
    curAnim.int=setInterval("zy_anim_slide_v()", 1);
}
function zy_anim_fade(a, b, d) {
	if(curAnim)
	 return;
    if (!d) d = 1;
    curAnim = new zy_anim(document.getElementById(a), document.getElementById(b), d,2);
    curAnim.int=setInterval("zy_anim_fade_()", 1);
}
function zy_anim_pop(a, b, d) {
	if(curAnim) 
	  return;
    if (!d) d = 1;
    curAnim = new zy_anim(document.getElementById(a), document.getElementById(b), d,3);
